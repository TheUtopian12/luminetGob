...
export const Cards = () => {
  ...
  return (
    ...
    >
      <div
        className="w-[70%] h-72 sm:h-72 bg-[url('/img/SERVICIOS-DE-RED-01.png')] bg-cover bg-center text-center grid rounded-3xl cursor-pointer"
        onClick={() => setFlip(!flip)}
      >
        <div className="flex items-end mb-0 font-bold">
          <p className="text-lg sm:text-2xl text-white mt-20 ml-10 mr-10">
      ...
      <div
        className="w-[70%] h-fit  bg-[#09284B] grid border-black border-2 rounded-3xl cursor-pointer"
        onClick={() => setFlip(!flip)}
      >
        <p className="m-10 text-white text-left pt-10">
          Servicio de red totalmente{" "}
          <span className="font-bold">gestionado y seguro</span> que ofrece
          servicios de alta calidad para{" "}
          <span className="font-bold">
            conectar diferentes oficinas o dependencias
          </span>{" "}
          entre sí: redes filiales, infraestructuras o aplicaciones en la nube,
