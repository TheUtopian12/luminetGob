...
export const Banner = () => {
  ...
  return (
    <div
      ...
      id="servicios"
    >
      <div className="text-white text-center ml-5 mr-5 mb-10 mt-10">
        <h1 className="text-lg  mb-5 font-extrabold sm:text-5xl mt-10 md:text-3xl">
          ¿Por qué luminet?
        </h1>
        <div className="flex justify-center ">
          ...
          >
            <Slider ref={sliderRef} {...settings}>
              <div>
                <h2 className="text-lg text-[23px] lg:text-[35px] sm:leading-[50px]">
                  Ofrecemos
              ...
              <div>
                <h2 className="text-lg text-[23px] lg:text-[33px]  sm:leading-[50px]">
                  Tenemos más de{" "}
                  <span className="text-[#76BA22] font-semibold">
                    23 años de experiencia
                  </span>
                  , con personal técnico capacitado y con herramientas
                  requeridas para un plan de remediación
                </h2>
              </div>
            </Slider>
          </div>
