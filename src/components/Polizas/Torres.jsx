      ...
      <div className="sm:flex gap-16  lg:w-[80%] sm:h-[500px] items-center p-10 rounded-3xl">
        ...
        <div className="sm:w-[50%] text-white">
          <h1 className="sm:text-left text-xl text-[#76BA22] font-bold mb-10">
            Mantenimiento de Torres <br className="md:hidden" /> de
            Telecomunicaciones{" "}
          </h1>

          <p className="mb-5 text-lg text-left hidden sm:grid">
            Ejecutamos las acciones y trabajos necesarios con el objetivo de
            asegurar la conservación de los anclajes y las estructuras de
            soporte, tramos de la torre y tensores.{" "}
          </p>
          <p className="text-lg text-left hidden sm:grid">
            Así como la verticalidad de la torre, el sistema de parrayos y
            tierra y retoque de pintura para evitar corrosión de ser necesaria.{" "}
          </p>
            ...
            texto={
              <div className="m-10">
                <p className="mb-5 text-lg text-left grid sm:hidden">
                  Ejecutamos las acciones y trabajos necesarios con el objetivo
                  de asegurar la conservación de los anclajes y las estructuras
                  de soporte, tramos de la torre y tensores.{" "}
                </p>
                <p className="text-lg text-left grid sm:hidden">
                  Así como la verticalidad de la torre, el sistema de parrayos y
                  tierra y retoque de pintura para evitar corrosión de ser
                  necesaria.{" "}
                </p>
